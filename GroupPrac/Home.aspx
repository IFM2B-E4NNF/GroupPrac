<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="GroupPrac.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="row">
								<div class="col-sm-1">
									...
									<p class="number_tetx">02/3</p>
									<div class="left_img"><img src="images/tutor2.jpg"></div>
								</div>
								<div class="col-sm-5">
									<h1 class="furniture_text">YOUR</h1>
									<h1 class="trends_text">TUTORING</h1>
									<h1 class="furniture_text">SOLUTION</h1>
									...
									<button class="furniture_bt">TUTORS</button>
								</div>
								<div class="col-sm-6">
									<div><img src="images/tutor2.jpg"></div>
								</div>
							</div>
						</div>
						<div class="carousel-item">
							<div class="row">
								...
								<div class="col-sm-5">
									<h1 class="furniture_text">YOUR</h1>
									<h1 class="trends_text">TUTOTING</h1>
									<h1 class="furniture_text">SOLUTION</h1>
									<P class="lorem_text">It is a long established fact that a reader will be distracted
										by the readable content of a page when looking at its layout. The point of using
										Lorem Ipsum is that it has a more-or-less normal distribution of letters, </P>
								...
								<div class="col-sm-6">
									<div><img src="images/tutor.jpg"></div>
								</div>
							</div>
						</div>
						<div class="carousel-item">
	...
	<div class="layout_padding about_section ">
		<div class="container">
			<h1 class="about_taital">About <span
					style="background-color: #00C2CB; color: #fff; padding: 0px 5px;">Us</span></h1>
			<p class="market_text">making it look like readable English. Many desktop publishing</p>
			<div class="about_bg">
				<div class="row">
					<div class="col-md-8">
						<p class="about_long_text">It is a long established fact that a reader will be distracted by the
							readable content of a page when looking at its layout. The point of using Lorem Ipsum is
							that it has a more-or-less normal distribution o
							f letters, a
							s opposed to using 'Content h
							ere, content here', making it look like readable English. Many desktop publishing packages
							and web</p>
	...
	<!-- about section end -->
	<!-- our tutor section start -->
	<div class="our_furniture_section layout_padding">
		<div class="container">
			<h1 class="about_taital">Our <span
					style="background-color: #00C2CB; color: #fff; padding: 0px 5px;">Tutors</span></h1>
			...
			<div class="col-sm-5">
				<div class="images_bt">
					...
					<div class="image_right">
						<div class="image_9"><img src="images/tutor1.png"></div>
						<div class="new_text"></div>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="image"><img src="images/tutor3.png"></div>
			</div>
			<div class="col-sm-3">
				<div class="image"><img src="images/tutor4.png"></div>
			</div>
		</div>
		<div class="images_section_2">
			<div class="row">
				<div class="col-sm-4">
					<div class="image_6"><img src="images/tutor_profile1.png"></div>
				</div>
				<div class="col-sm-4">
					<div class="image_6"><img src="images/tutor_profile2.png"></div>
				</div>
				<div class="col-sm-4">
					<div class="image_6"><img src="images/tutor1.jpg"></div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<h1 class="testi_monila_text">Testi <span
								style="background-color: #00C2CB; color: #fff; padding: 0px 5px;">Monial</span></h1>
